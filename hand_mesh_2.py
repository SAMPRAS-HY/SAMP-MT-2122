...
def passDistance(a):
    ...
    if dis_x in range(0, 150) and dis_y in range(0,50):
        cv2.putText(image, 'warning', (1020, 40), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 1, cv2.LINE_AA)
    ...
    if results.multi_hand_landmarks:
      for hand_landmarks in results.multi_hand_landmarks:
        ...
        for point in results.multi_hand_landmarks:
                ...
                h_pixelCoordinatesLandmark = mp_drawing._normalized_to_pixel_coordinates(h_normalizedLandmark.x, h_normalizedLandmark.y, imageWidth, imageHeight)

                print('Hand')
                print(h_pixelCoordinatesLandmark)
                print(h_normalizedLandmark)
                if h_pixelCoordinatesLandmark:
    ...
    if results.multi_face_landmarks:
      for face_landmarks in results.multi_face_landmarks:
        ...
        for point in results.multi_face_landmarks:
            ...
            r_pixelCoordinatesLandmark = mp_drawing._normalized_to_pixel_coordinates(r_normalizedLandmark.x, r_normalizedLandmark.y, imageWidth, imageHeight)
            ...
            l_pixelCoordinatesLandmark = mp_drawing._normalized_to_pixel_coordinates(l_normalizedLandmark.x, l_normalizedLandmark.y, imageWidth, imageHeight)
